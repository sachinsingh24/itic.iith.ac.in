...
const Aisea = () => {
  return (
    <>
      <PageTitle
        title="AISEA"
        subtitle="Unimpeded Acceleration!"
        bg={_asset0}
      />
            ...
            <div className="col-lg-12 col-md-16">
              <div className="overview-content pl-3">
                <p>
                  ...
                  Hyderabad. AISEA started its operations early in the year 2020
                  post getting support from the Department of Science and
                  Technology, Government of India under the NIDHI Accelerator
                  scheme.
                  <br />
                  <br />
                ...
                <p>
                  AISEA conducted two cohorts of 4 months each, with 15 startups
                  graduating in Cohort 1 and 14 startups graduating in Cohort 2.
                </p>
                <p>
                  AISEA program is currently inactive. Please check other programs
                  for startup support.
                </p>
              </div>
            </div>
  ...
  {[
                    ...
                    },
                    {
                      ...
                      body:
                        'AISEA does not invest in startups directly as of now. However, we do connect startups to various investors from the network of AISEA, iTIC Incubator, and Action For India. Startups will get several opportunities to meet investors during the course of the program.',
                    },
                    {
                      title:
                        'Does AISEA get any ownership on the Intellectual Property of startups?',
                      body:
                        'AISEA does not ask for any ownership of the existing or the new IP developed by the startups.',
                    },
                    {
                      title: 'Does AISEA charge anything for the program?',
                      body:
                        'AISEA does not charge any cash or equity from the startups for the Accelerator program',
                    },
                    {
                      title: 'What happens after the program?',
                      body:
                        'The graduating startups become a part of the Alumni network of AISEA and can leverage the benefits of IIT Hyderabad and Action For India\u2019s network of students, faculties, researchers, mentors, investors, policymakers, etc.',
                    },
                  ].map((item, i) => (
