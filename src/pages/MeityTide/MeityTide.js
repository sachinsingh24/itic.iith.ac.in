...
const MeityTide = () => {
  return (
    <>
      <PageTitle
        ...
        subtitle="Enabling Environment for Technology Adoption"
        bg={_asset0}
      />
            ...
            <div className="col-lg-12 col-md-12">
              <div className="overview-content">
                <p>
                  ...
                  through financial and technical support for ICT startups
                  primarily engaged in emerging technologies such as IoT, AI,
                  Blockchain, Robotics etc. Some of the pre-identified areas of
                  societal relevance are Education, Agriculture, Financial
                  inclusion including digital payments, Infrastructure and
                  transportation, Environment and cleantech, Clean energy and
  ...
  {[
                    ...
                    },
                    {
                      ...
                      body:
                        'Kindly apply using our preincubation form from our website.',
                    },
                    {
