        ...
        <div className="row">
          <div className="col-lg-4 col-md-5 col-12">
            <div className="single-footer-widget footer-about">
              ...
              <p>iTIC Incubator at IIT Hyderabad focuses on supporting deeptech startups from idea to growth stage under its structured pre-incubation, incubation and accelerator programs.</p>
              <div className="logo">
                <img alt="" src={_asset1} />
              </div>
            </div>
          ...
          <div className="col-lg-2 col-md-5 col-6">
            <div className="single-footer-widget">
              ...
              <ul className="services-list">
                ...
                <li>
                  <Link to="/eeiith">Entrepreneurship Ecosystem at IITH</Link>
                </li>
                <li>
                ...
                <li>
                  <Link to="/contact-us">Book a Meeting</Link>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="col-lg-2 col-md-5 col-6">
            <div className="single-footer-widget">
              ...
              <ul className="support-list">
                ...
                <li>
                  <Link to="/tihan">TiHAN</Link>
                </li>
                <li>
                  <Link to="/idex-dio">iDEX</Link>
                </li>
                <li>
                  <Link to="/nidhi-prayas">NIDHI PRAYAS</Link>
                </li>
                <li>
                  <Link to="/meity-tide">Meity TIDE 2.0</Link>
                </li>
                <li>
                  <Link to="/aisea">AISEA</Link>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div>
            <ul className="footer-contact-info">
              <li style={{ color: "#acc5db", listStyle: "none" }}>
                <i className="fa-solid fa-house-chimney"></i>&nbsp; Address: Technology Innovation Park, IIT HYDERABAD, Kandi, Sangareddy , Telangana India- 502284
                <br />
                <i className="fa-solid fa-envelope"></i>&nbsp; Email: <a href="mailto:contact@itic.iith.ac.in">contact@itic.iith.ac.in</a> &nbsp;
                <i className="fa-solid fa-phone"></i> Mobile: <a href="tel:+918331036155">+91 83310 36155</a>
                <br />
